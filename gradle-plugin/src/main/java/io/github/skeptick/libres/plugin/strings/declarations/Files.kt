...
internal fun StringsInterfaceFile(
    packageName: String,
    stringsInterfaceBuilder: TypeSpec.Builder
): FileSpec {
...
internal fun StringsObjectFile(
    packageName: String,
    stringsObjectBuilder: TypeSpec.Builder
): FileSpec {
...
internal fun FormattedClassesFile(
    packageName: String,
    classes: Iterable<TypeSpec.Builder>
): FileSpec {
